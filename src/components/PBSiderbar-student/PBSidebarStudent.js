    ...
    <div className={click ? "SidebarPB Narrow" : "SidebarPB"}>
      ...
      <div>
        <ul className={click ? "PBListWrapper Narrow" : "PBListWrapper"}>
          {/* --------------------------------- Link 1 ---------------------------------*/}
          <li className={click ? "SidebarPBRow Narrow" : "SidebarPBRow"}>
            <NavLink
              className={({ isActive }) =>
                isActive ? "NavLink1 Dark" : "NavLink1"
              }
            ...
            >
              <img
                className={click ? "SidebarPBImage Narrow" : "SidebarPBImage"}
                src="../../Images/Student Areas/objectives.png"
                alt="#"
                width={28}
              />
              <span
                className={click ? "SidebarPBTitle Narrow" : "SidebarPBTitle"}
              >
                LEARNING OBJECTIVES
              </span>
            </NavLink>
          ...
          <li className={click ? "SidebarPBRow Narrow" : "SidebarPBRow"}>
            <NavLink
              className={({ isActive }) =>
                isActive ? "NavLink2 Dark" : "NavLink2"
              }
          ...
          <li className={click ? "SidebarPBRow Narrow" : "SidebarPBRow"}>
            <NavLink
              className={({ isActive }) =>
                isActive ? "NavLink3 Dark" : "NavLink3"
              }
          ...
          <li className={click ? "SidebarPBRow Narrow" : "SidebarPBRow"}>
            <NavLink
              className={({ isActive }) =>
                isActive ? "NavLink4 Dark" : "NavLink4"
              }
              to="/projectbuilder/makeproject/1"
              style={({ isActive }) =>
                isActive
                  ? {
                      color: "#707070",
          ...
          <li className={click ? "SidebarPBRow Narrow" : "SidebarPBRow"}>
            <NavLink
              className={({ isActive }) =>
                isActive ? "NavLink5 Dark" : "NavLink5"
              }
