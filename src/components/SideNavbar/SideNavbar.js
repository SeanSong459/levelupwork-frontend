        ...
        <div className='sideNavBar'>
            ...
            <div className='progress-tracker'>
                <div className='p-tracker'>
                    <h5><img className='img' src={ProgressTracker} alt="progress-tracker" width={28} />PROGRESS TRACKER</h5>
                </div>
            </div>
            <div className='IconGraduate'>
                <div className='p-tracker'>
                    <h5><img className='img' src={IconGraduate} alt="progress-tracker" width={28} />STUDENT PROFILE</h5>
                </div>
            </div>
            <div className='HelpRequest'>
                <div className='p-tracker'>
                    <h5><img className='img' src={HelpRequest} alt="progress-tracker" width={28} />HELP REQUEST</h5>
                </div>
            </div>
            <div className='ProjectSub'>
                <div className='p-tracker'>
                    <h5><img className='img' src={ProjectSub} alt="progress-tracker" width={28} />PROJECT SUBMISSIONS</h5>
                </div>
            </div>
            <div className='ProjectLibrary'>
                <div className='p-tracker'>
                    <h5><img className='img' src={ProjectLibrary} alt="progress-tracker" width={28} />PROJECT LIBRARY</h5>
                </div>
            </div>
            ...
            <div className="Icon-profile">
                ...
                <img className='icon' src={IconProfile} width={14} alt="profile" /><p>Profile</p>
                </div>
                <div className="profile">
                <img className='icon' src={IconSetting} width={14} alt="profile" /><p>Settings</p>
                </div>
                <div className="profile">
                <img className='icon' src={IconLogOut} width={14} alt="profile" /><p>Log out</p>
                </div>
            </div>
        </div>
    )
